...
export const mockWeeklyChallenges: WeeklyChallenge[] = [
  ...
  {
    id: 'wc-6',
    title: 'Embaixador Kivara',
    description: 'Convida 3 amigos para se juntarem ao Kivara usando o teu código de referral.',
    type: 'social',
    icon: '🤝',
    targetValue: 3,
    currentValue: 1,
  ...
  {
    id: 'wc-7',
    title: 'Desafio da Poupança com Amigos',
    description: 'Tu e os teus amigos poupam juntos — ganha quem poupar mais esta semana!',
    type: 'social',
    icon: '🏆',
    targetValue: 100,
    currentValue: 45,
  ...
  {
    id: 'wc-8',
    title: 'Força de Equipa',
    description: 'Completa 10 tarefas em conjunto com amigos da tua turma.',
    type: 'social',
    icon: '💪',
    targetValue: 10,
    currentValue: 10,
...
export const mockFriendsLeaderboard: ClassLeaderboardEntry[] = [
  { rank: 1, name: 'Ana', avatar: '🦊', score: 240, challengesCompleted: 3, isCurrentUser: true },
  { rank: 2, name: 'Sofia M.', avatar: '👧', score: 220, challengesCompleted: 3 },
  { rank: 3, name: 'Tomás R.', avatar: '👦', score: 180, challengesCompleted: 2 },
  { rank: 4, name: 'Inês P.', avatar: '👩', score: 150, challengesCompleted: 2 },
  { rank: 5, name: 'Pedro L.', avatar: '🐻', score: 120, challengesCompleted: 1 },
];

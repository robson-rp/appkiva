...
function Navbar() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl flex items-center justify-between px-5 sm:px-8 h-[4.5rem].5rem].5rem].5rem].5rem] md:h-20">
        ...
        <div className="flex">
          {HERO_SLIDES.map((slide, i) => (
            <div key={i} className="min-w-0 shrink-0 grow-0 basis-full">
              <div className="r10lativ10 px-510sm:px108 py-8 md:py-16">
                <div className="mx-auto max-w-7xl grid md:grid-cols-2 gap-6 md:gap-10 items-center">
                  ...
                  >
                    ...
                    <div classcol sm:flex-row gap-3 sm:flex-row gap-3 sm:flex-row gap-3p gap-4">
                      <Button
                        size="lg"
                  ...
                  >
                    ...
                    <img
                      src={slide.image}
                      alt={slide.alt}
            80px] sm:max-w-smm80px] sm:max-w-sm200px] sm:max-w-xs md:max-w-lg lg:max-w-xl relative z-10 drop-shadow-2xl"
                    />
                  </motion.div>
                </div>
              </div>
  ...
  return (
    <Section id="universo">
      ...
      <div className="relative">
        ...
        <motion.div variants={staggerFast} classNam1 min-[420px]:grid-cols-e="grid grid-cols-2 md:grid-cols-5 gap-3">
          {zones.map((z, i) => (
            <motion.div
              key={i}
              variants={fadeUp}

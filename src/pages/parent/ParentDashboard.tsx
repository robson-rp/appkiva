...
import { Users, ListTodo, CheckCircle, PiggyBank, TrendingUp, ChevronRight, ArrowUpRight, ArrowDownLeft, Sparkles, Target, Handshake, Send, Gauge, Crown, Lock, Check } from 'lucide-react';
...
export default function ParentDashboard() {
  ...
  const { enabledFeatures, tierName, loading: featuresLoading } = useAllFeatures();

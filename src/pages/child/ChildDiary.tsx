...
function calcStreak(entries: typeof mockDiaryEntries): number {
...
export default function ChildDiary() {
  ...
  const [entries, setEntries] = useState(mockDiaryEntries.filter((e) => e.childId === child.id));
              ...
              <Card className="border-border/50 overflow-hidden">
                ...
                <CardContent className="p-4 space-y-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      <PenLine className="h-4 w-4" /> Guardar
                    </Button>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className="flex gap-3 p-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-[11px] font-display font-bold text-primary">{formatDate(entry.date)}</span>
                        {entry.tags && (

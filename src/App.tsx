  ...
  if (user.role === 'admin') {
    return (
      <Routes>
        ...
        <Route path="/admin/banners" element={<AdminLayout><S><AdminBanners /></S></AdminLayout>} />
        <Route path="/admin/missions" element={<AdminLayout><S><AdminMissions /></S></AdminLayout>} />
        {INSTALL_ROUTE}
  ...
  if (user.role === 'parent') {
    return (
      <Routes>
        ...
        <Route path="/parent/dreams" element={<ParentLayout><S><ParentDreams /></S></ParentLayout>} />

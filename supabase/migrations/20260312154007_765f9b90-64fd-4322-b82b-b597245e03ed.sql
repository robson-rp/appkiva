...
BEGIN
  ...
  -- Sum all emissions created by this parent this month (including vault_deposit from system wallet)
  ...
  WHERE le.created_by = _parent_profile_id
    ...
    AND le.entry_type IN ('allowance', 'task_reward', 'mission_reward', 'adjustment', 'refund', 'vault_deposit');
